...
export class Display3vlHex extends Display3vlWithRegex {
    constructor() {
        super("[0-9a-fx]*");
        this.name = "hex";
        this.sort = 0;
...
;
export class Display3vlBin extends Display3vlWithRegex {
    constructor() {
        super("[01x]*");
        this.name = "bin";
        this.sort = 0;
...
;
export class Display3vlOct extends Display3vlWithRegex {
    constructor() {
        super("[0-7x]*");
        this.name = "oct";
        this.sort = 0;
