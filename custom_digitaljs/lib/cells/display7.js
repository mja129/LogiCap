...
exports.Display7View = exports.Display7 = void 0;
 ...
 */
const Display7 = exports.Display7 = _io.IO.define('Display7', {
  bits: 8,
  size: {
    width: 76.5,
    height: 110
  ...
  markupBus: _io.NumBase.prototype.markup.concat([{
    tagName: 'rect',
    selector: 'display'
  }, {
    tagName: 'polygon',
...
const Display7View = exports.Display7View = _io.IOView.extend({
  ...
  _updateDisplay() {
    ...
    const newAttrs = {
      dp: {
        fill: inputSignal.get(7) === 1 ? highColor : lowColor
      },
      a: {
        fill: inputSignal.get(6) === 1 ? highColor : lowColor
      },
      b: {
        fill: inputSignal.get(5) === 1 ? highColor : lowColor
      },
      c: {
        fill: inputSignal.get(4) === 1 ? highColor : lowColor
      },
      d: {
        fill: inputSignal.get(3) === 1 ? highColor : lowColor
      },
      e: {
        fill: inputSignal.get(2) === 1 ? highColor : lowColor
      },
      f: {
        fill: inputSignal.get(1) === 1 ? highColor : lowColor
      },
      g: {
        fill: inputSignal.get(0) === 1 ? highColor : lowColor
      }
    };
